...
list_path <- '_posts/2021-11-14-meu-deck-no-gwent/temporario_lista'
### para os decks
deck_path <- '_posts/2021-11-14-meu-deck-no-gwent/temporario_deck'
...
decks <- map_dfr(.x = decks_disponiveis, 
                 .f = parser_cards, 
                 .id = 'deck') %>% 
