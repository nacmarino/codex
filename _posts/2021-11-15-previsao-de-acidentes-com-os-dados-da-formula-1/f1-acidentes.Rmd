---
title: "Previsao de acidentes com os dados da Formula 1"
description: |
...
Para extrair àquelas informações da Wikipedia utilizei a _url_ da Wikipedia que está relacionada à cada prova, e disponível na tabela `races`. Eu criei um _scrapper_ para ir até uma dessas páginas e extrair as informações e metadados sobre cada cada uma das provas. A partir daí eu fiz um parser e montei a base de dados que ajusto abaixo. Você encontra esse _scrapper_ dentro da pasta deste _post_, neste link. 
